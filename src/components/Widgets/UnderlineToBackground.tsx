...
const UnderlineToBackground = ({
  ...
  return (
    <motion.span
      className={`relative inline-block cursor-pointer ${className} text-primary`}
      whileHover="target"
      onClick={onClick}
      ref={textRef}
      {...props}
    >
      <motion.div
        className="absolute bg-current w-full desktop:-ml-3 mobile:-ml-1 rounded-lg"
        style={{
          height: "var(--underline-height)",
          bottom: "calc(10 * var(--underline-padding))",
        }}
